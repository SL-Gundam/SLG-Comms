 ...
 *
 *   $Id: admin.php,v 1.20 2005/06/20 15:25:38 SC Kruiper Exp $
 *
 *
 ***************************************************************************/
...
$page_title = $tssettings['Page title']; // backup of name before modification.
$tssettings['Page title'] .= ' - {TEXT_ADMIN}';
include_once('includes/header.inc.php');
$template = 'admin'; //the include_once for header.inc.php resetted this variable to another value so we said it back to the correct one for further use in this script. this can not be any other order because secure.inc.php requires to be within a template but before any output to the client. So it should be before header.inc.php but after the start of the template of the main working file.
$tssettings['Page title'] = $page_title; // settings checks this value for changes so we need to set it back to the value in the database. This is only neccasary in the admin pages. more precise it's only needed for the settings page within the admin pages.
